    ...
    public static void init() {
        try {
            ...
            if (file.exists()) {
                ...
                int total = Integer.parseInt(UT.parseJson(JSONObject.fromObject(res), "data:size"));
        ...
        try {
            ...
            if (file.exists()) {
                ...
                int total_1 = Integer.parseInt(UT.parseJson(JSONObject.fromObject(res), "data:list()")); // 一级分类个数
