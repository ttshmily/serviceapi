...
public class SearchDoctors extends BaseTest{
    ...
    public void test_01_查询医生列表_输入医生姓名(){
        ...
        Assert.assertNull(s_ParseJson(data,"list"),"输入无效医生姓名应返回空结果");
    }
    ...
    public void test_02_查询医生列表_输入医生所在医院(){
        ...
        s_CheckResponse(res);
        Assert.assertEquals(code, "1000000");
        Assert.assertNull(s_ParseJson(data,"list"),"输入无效医生医院名称应返回空结果");
    }
    ...
    public void test_03_查询医生列表_输入疾病名(){
        ...
        logger.info("输入无效疾病名");
        query.put("disease_name", "11111");
        query.put("page", "1");
        query.put("pageSize", "10");
        res = HttpRequest.s_SendGet(host_ims + uri, query, crm_token);
        s_CheckResponse(res);
        Assert.assertEquals(code, "1000000");
        Assert.assertNull(s_ParseJson(data, "list"),"输入无效疾病名称应返回空结果");
    }
    ...
    public void test_04_查询医生列表_输入一级分类(){
        ...
        query.put("parent_category_id", null);
        query.put("page", "1");
        query.put("pageSize", "10");
        res = HttpRequest.s_SendGet(host_ims + uri, query, crm_token);
        s_CheckResponse(res);
        ...
        s_CheckResponse(res);
        Assert.assertEquals(code, "1000000");
        Assert.assertNull(s_ParseJson(data, "list"),"输入无效一级分类名时应返回空结果");
    }
    ...
    public void test_05_查询医生列表_输入二级分类() {
        ...
        s_CheckResponse(res);
        Assert.assertEquals(code, "1000000");
        Assert.assertNull(s_ParseJson(data,"list"), "输入无效的二级分类应返回空结果");
    }
    ...
    public void test_06_查询医生列表_输入城市(){
        ...
        s_CheckResponse(res);
        Assert.assertEquals(code, "1000000");
        Assert.assertNull(s_ParseJson(data, "list"),"输入无效城市名时应返回空结果");
    }
