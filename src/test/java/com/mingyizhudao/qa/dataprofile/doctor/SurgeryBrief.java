...
public class SurgeryBrief {
    ...
    public SurgeryBrief(boolean init) {
        ...
        if (init) {
            brief.put("surgery_brief_hospital_id", UT.randomHospitalId());
            brief.put("surgery_brief_date", UT.randomDateTillNow());
            brief.put("surgery_brief_description", UT.randomString(100));
            brief.put("surgery_brief_final_diagnosed_disease_id", UT.randomDiseaseId());
            brief.put("surgery_brief_surgery_id", UT.randomSurgeryId());
