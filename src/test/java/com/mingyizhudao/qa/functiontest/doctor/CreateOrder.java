...
public class CreateOrder extends BaseTest {
    ...
    public void test_01_创建订单_信息齐备_已认证用户() {
        ...
        res = HttpRequest.s_SendPost(host_doc + uri, JSONObject.fromObject(su).toString(), mainToken);
        s_CheckResponse(res);
        ...
        Assert.assertEquals(s_ParseJson(data, "agent_referrer_id"), "SH0133"); //常州市武进人民医院, 常州，区域服务人员 - 方超 - SH0133
        Assert.assertEquals(s_ParseJson(data, "agent_referrer_name"), "方超"); //常州市武进人民医院, 常州，区域服务人员 - 方超 - SH0133
        Assert.assertNotNull(s_ParseJson(data, "agent_city_id"));
        Assert.assertNotNull(s_ParseJson(data, "agent_city_name"));
        Assert.assertEquals(s_ParseJson(data, "agent_hospital"), "常州市武进人民医院");
    ...
    public void test_02_创建订单_信息齐备_未登录用户() {
        ...
        String res = "";
        SurgeryOrder su = new SurgeryOrder("order");
        res = HttpRequest.s_SendPost(host_doc + uri, JSONObject.fromObject(su).toString(), "");
        s_CheckResponse(res);
    ...
    public void test_03_创建订单_缺少患者姓名不可以创建() {
        ...
        jsonConfig.setExcludes(new String[]{"patient_name"});
        SurgeryOrder su1 = new SurgeryOrder("order");
        res = HttpRequest.s_SendPost(host_doc + uri, JSONObject.fromObject(JSONSerializer.toJSON(su1, jsonConfig)).toString(), mainToken);
        s_CheckResponse(res);
        Assert.assertNotEquals(code, "1000000");
    }
    ...
    public void test_04_创建订单_缺少患者性别或性别不正确不可以创建() {
        ...
        JsonConfig jsonConfig = new JsonConfig();
        jsonConfig.setExcludes(new String[]{"patient_gender"});
        SurgeryOrder su1 = new SurgeryOrder("order");
        res = HttpRequest.s_SendPost(host_doc + uri, JSONObject.fromObject(JSONSerializer.toJSON(su1, jsonConfig)).toString(), mainToken);
        s_CheckResponse(res);
    ...
    public void test_05_创建订单_缺少患者年龄不可以创建() {
        ...
        JsonConfig jsonConfig = new JsonConfig();
        jsonConfig.setExcludes(new String[]{"patient_age"});
        SurgeryOrder su1 = new SurgeryOrder("order");
        res = HttpRequest.s_SendPost(host_doc + uri, JSONObject.fromObject(JSONSerializer.toJSON(su1, jsonConfig)).toString(), mainToken);
        s_CheckResponse(res);
        Assert.assertNotEquals(code, "1000000");
    ...
    public void test_06_创建订单_缺少患者手机不可以创建() {
        ...
        JsonConfig jsonConfig = new JsonConfig();
        jsonConfig.setExcludes(new String[]{"patient_phone"});
        SurgeryOrder su1 = new SurgeryOrder("order");
        res = HttpRequest.s_SendPost(host_doc + uri, JSONObject.fromObject(JSONSerializer.toJSON(su1, jsonConfig)).toString(), mainToken);
        s_CheckResponse(res);
        Assert.assertEquals(code, "1000000"); // PD要求可以创建。。。
    ...
    public void test_07_创建订单_缺少主诉疾病不可以创建() {
        ...
        JsonConfig jsonConfig = new JsonConfig();
        jsonConfig.setExcludes(new String[]{"major_disease_id"});
        SurgeryOrder su1 = new SurgeryOrder("order");
        res = HttpRequest.s_SendPost(host_doc + uri, JSONObject.fromObject(JSONSerializer.toJSON(su1, jsonConfig)).toString(), mainToken);
        s_CheckResponse(res);
        Assert.assertNotEquals(code, "1000000");
    ...
    public void test_08_创建订单_缺少次诉疾病可以创建() {
        ...
        JsonConfig jsonConfig = new JsonConfig();
        jsonConfig.setExcludes(new String[]{"minor_disease_id"});
        SurgeryOrder su1 = new SurgeryOrder("order");
        res = HttpRequest.s_SendPost(host_doc + uri, JSONObject.fromObject(JSONSerializer.toJSON(su1, jsonConfig)).toString(), mainToken);
        s_CheckResponse(res);
        Assert.assertEquals(code, "1000000");
    ...
    public void test_11_创建订单_信息齐备_期望手术医院不传() {
        ...
        JsonConfig jsonConfig = new JsonConfig();
        jsonConfig.setExcludes(new String[]{"expected_surgery_hospital_id"});
        SurgeryOrder su1 = new SurgeryOrder("order");
        res = HttpRequest.s_SendPost(host_doc + uri, JSONObject.fromObject(JSONSerializer.toJSON(su1, jsonConfig)).toString(), mainToken);
        s_CheckResponse(res);
        Assert.assertEquals(code, "1000000", "创建订单失败");
    ...
    public void test_12_创建订单_病例图片作为非必填字段() {
        String res = "";
        JsonConfig jsonConfig = new JsonConfig();
        jsonConfig.setExcludes(new String[]{"medical_record_pictures"});
        SurgeryOrder su1 = new SurgeryOrder("order");
        res = HttpRequest.s_SendPost(host_doc + uri, JSONObject.fromObject(JSONSerializer.toJSON(su1, jsonConfig)).toString(), mainToken);
        s_CheckResponse(res);
        Assert.assertEquals(code, "1000000");
