...
public class Order_TrackList extends BaseTest {
    ...
    public void test_01_获取订单操作记录_所有() {
        ...
        Assert.assertEquals(Helper.s_ParseJson(data, "list()"), "1");
        ...
        s_CheckResponse(res);
        Assert.assertEquals(code, "1000000");
        Assert.assertEquals(Helper.s_ParseJson(data, "list()"), "4");
        ...
        int id4 = Integer.parseInt(Helper.s_ParseJson(data, "list(3):id"));
    ...
    public void test_02_获取订单操作记录_三方通话记录() {
        ...
        s_CheckResponse(res);
        Assert.assertEquals(code, "1000000");
        Assert.assertEquals(Helper.s_ParseJson(data, "list()"), "0");
        ...
        s_CheckResponse(res);
        Assert.assertEquals(code, "1000000");
        Assert.assertEquals(Helper.s_ParseJson(data, "list()"), "5");
        ...
        s_CheckResponse(res);
        Assert.assertEquals(code, "1000000");
        Assert.assertEquals(Helper.s_ParseJson(data, "list()"), "6");
        ...
        s_CheckResponse(res);
        Assert.assertEquals(code, "1000000");
        Assert.assertEquals(Helper.s_ParseJson(data, "list()"), "7");
        ...
        s_CheckResponse(res);
        Assert.assertEquals(code, "1000000");
        Assert.assertEquals(Helper.s_ParseJson(data, "list()"), "8");
